                ...
                <div class='navbar-container clearfix'>
                    ...
                    <div class='pull-right'>
                        ...
                        <ul class='nav pull-right right-menu'>
                            ...
                            <li class='more-options dropdown'>
                                <a data-toggle='tooltip' data-placement='left' title='Agenda' data-original-title='Agenda'>
                                    <i class='zmdi zmdi-calendar'></i>
                                </a>
                            </li>
                            <li class='more-options dropdown'>
                                <a data-toggle='tooltip' data-placement='left' title='Configurações' data-original-title='Configurações'>
                ...
                <ul class='nav metismenu'>
                    ...
                    <li>
                        ...
                        <ul class='nav nav-inside collapse'>
                            ...
                            <li class='menu-child'>
                                <a aria-expanded='false' href='#'><i class='zmdi zmdi-email'></i>
                                    Classificações<span class='zmdi arrow'></span>
                                </a>
                                <ul aria-expanded='false' class='nav nav-inside collapse'>
                                    <li class='inside-title'>Classificações</li>
                                    <li><p class='m-t-15 m-l-20 f-s-16' style='color: #546e7a'>Débitos</p></li>
                                    <li><a href='{{url('restrito/posts/categorias')}}'>Categorias</a></li>
                                    <li><a href='{{url('restrito/posts/subcategorias')}}'>SubCategorias</a></li>
                                    <li><a href='{{url('restrito/posts/posicoes')}}'>Posições Blog</a></li>
                                    <li><a href='{{url('restrito/posts/posicoes-anuncios')}}'>Posições Banners</a></li>
                                    <li><a href='{{url('restrito/posts/posicoes-anuncios')}}'>Reações</a></li>
                                    <li><a href='{{url('restrito/posts/paginas')}}'>Páginas</a></li>
                                </ul>
                            </li>
                            <li class='menu-child'>
                                <a aria-expanded='false' href='#'><i class='zmdi zmdi-email'></i>
                                    Posts<span class='zmdi arrow'></span>
                                </a>
                                <ul aria-expanded='false' class='nav nav-inside collapse'>
                                    <li class='inside-title'>Posts</li>
                                    <li><p class='m-t-15 m-l-20 f-s-16' style='color: #546e7a'>Débitos</p></li>
                                    <li><a href='{{url('restrito/posts/artigos')}}'>Artigos</a></li>
                                    <li><a href='{{url('restrito/posts/artigos')}}'>Banners</a></li>
                    ...
                    <li>
                        <a href='#'><i class='zmdi zmdi-labels'></i>Tickets
                            <span class='zmdi arrow'></span>
                        </a>
                    </li>
