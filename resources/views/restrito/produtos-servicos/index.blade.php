            ...
            <table id="tableSearch" class="display datatable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$registro->PROD_VALOR}}</td>
                        <td>{{$registro->PROD_TIPO}}</td>
                        <td>
                            <a href='#' class='btn btn-default btn-xs white m-r-5'
                               onclick="deletar('{{url("/restrito/$page/deletar/$registro->PROD_CODIGO")}}')" id='urlDeletar' >
                                <i class='zmdi zmdi-delete'></i> Del
                            </a>
                            <a href='{{url("/restrito/$page/editar/$registro->PROD_CODIGO")}}' class='btn btn-primary btn-xs white'>
