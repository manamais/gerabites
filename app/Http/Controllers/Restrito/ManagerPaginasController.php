...
use App\Models\Restrito\Paginas;
use Gate;

class ManagerPaginasController extends StandardController {

    protected $model;
    protected $request;
    protected $page;
    protected $gate;
    protected $nomeView = 'restrito.manager-pagina';
    protected $redirectIndex = '/restrito/paginas';

    public function __construct(Paginas $model, Request $request) {
        $this->model = $model;
        $this->request = $request;
        $this->page = "paginas";
        $this->titulo = "GERENCIAMENTO DAS PÁGINAS";
    ...
    public function cadastrarDB() {
        ...
        $title = str_slug($dadosForm['PAG_TITULO'], '-');
        $slug = array('PAG_SLUG' => $title);
