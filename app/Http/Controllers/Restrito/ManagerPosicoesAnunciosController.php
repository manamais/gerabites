...
class ManagerPosicoesAnunciosController extends StandardController {

    protected $model;
    protected $request;
    protected $page;
    protected $gate;
    protected $nomeView = 'restrito.manager-posicao-anuncio';
    protected $redirectIndex = '/restrito/posicoes-anuncios';

    public function __construct(PosicoesAnuncios $model, Request $request) {
        $this->model = $model;
        $this->request = $request;
        $this->page = "posicoes-anuncios";
        $this->titulo = "DISPOSIÇÃO DOS ANÚNCIOS";
