                ...
                <table class='table table-hover datatable'>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$registro->SUBCAT_TITULO}}</td>
                            <td>{{$registro->SUBCAT_DESCRICAO}}</td>
                            <td class='hidden'></td>
                            <td class='hidden'></td>
                            <td>
                                <a href='#' class='label label-danger m-r-5'
                                   onclick="deletar('{{url("/restrito/$page/deletar/$registro->SUBCAT_CODIGO")}}')" id='urlDeletar' >
                                    <i class='fa fa-trash-o'></i> Del
                                </a>

                                <a href='{{url("/restrito/$page/editar/$registro->SUBCAT_CODIGO")}}' class='label label-success'>
